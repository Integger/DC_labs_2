...
class Fork:
    def __init__(self, tine_length = 1):
        ...
        """
        if not isinstance(tine_length, int):
            raise TypeError("tine_length must be int")
        if tine_length not in range(1, 25):
            raise ValueError("The value of tine_length must be in the range from 1 to 25")
            
        self.tine_length = tine_length
...
class Spoon:
    def __init__(self, bottom_depth = 1):
        ...
        """
        if not isinstance(bottom_depth, int):
            raise TypeError("bottom_depth must be int")
        if bottom_depth not in range(1, 10):
            raise ValueError("The value of bottom_depth must be in the range from 1 to 25")
...
class Table:
    ...
    def take_item(self, item_name) -> None:
        ...
        if not isinstance(item_name, str):
            raise TypeError("item_name must be string")
